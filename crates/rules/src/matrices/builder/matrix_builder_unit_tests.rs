...
fn empty_primary_is_err() {
    ...
    assert_eq!(
        res,
        MatrixBuilderBuildResult::Err(MatrixBuilderValidation::RoleInIsolation {
...
fn set_number_of_days_cannot_be_zero() {
    ...
    // Confirmation
    sut.add_factor_source_to_confirmation_override(FactorSourceID::sample_password())
        .unwrap();
...
fn set_number_of_days_42() {
    ...
    pretty_assertions::assert_eq!(
        ...
        MatrixOfFactorSourceIds::with_roles_and_days(
            ...
            RoleWithFactorSourceIds::recovery_with_factors([FactorSourceID::sample_ledger(),],),
            RoleWithFactorSourceIds::confirmation_with_factors([FactorSourceID::sample_password()],),
            42,
        )
    );
}
...
mod remove {
    ...
    fn remove_from_recovery_is_ok() {
        let mut sut = make();
        sut.add_factor_source_to_recovery_override(FactorSourceID::sample_device())
            .unwrap();
        let res = sut.remove_factor(&FactorSourceID::sample_device());
        assert_eq!(res, Ok(()));
    }
...
mod validation_for_addition_of_factor_source_for_each {
    ...
    mod recovery {
        ...
        fn role() -> sargon::RoleKind {
            sargon::RoleKind::Recovery
        }
        ...
        fn supported() {
            ...
            pretty_assertions::assert_eq!(
                ...
                fsids
                    .into_iter()
                    .map(|fsid| FactorSourceInRoleBuilderValidationStatus::ok(role(), fsid))
                    .collect::<Vec<_>>()
            );
        }
...
mod validation_of_addition_of_kind {
    ...
    mod primary {
        ...
        fn passphrase_threshold_threshold() {
            // ARRANGE
            let mut sut = make();
            sut.add_factor_source_to_primary_threshold(FactorSourceID::sample_passphrase())
                .unwrap();
        ...
        fn passphrase_override_override() {
            // ARRANGE
            let mut sut = make();
            sut.add_factor_source_to_primary_override(FactorSourceID::sample_passphrase())
                .unwrap();
...
mod shield_configs {
    ...
    mod mvp {
        ...
        fn config_1_2() {
            ...
            sut.add_factor_source_to_primary_threshold(FactorSourceID::sample_ledger())
                .unwrap();
            let res = sut.add_factor_source_to_primary_threshold(FactorSourceID::sample_password());
        ...
        fn config_2_2() {
            ...
            sut.add_factor_source_to_primary_threshold(FactorSourceID::sample_ledger())
                .unwrap();
            sut.add_factor_source_to_primary_threshold(FactorSourceID::sample_ledger_other())
                .unwrap();
            sut.set_threshold(2).unwrap();
        ...
        fn config_2_4() {
            ...
            // Confirmation
            sut.add_factor_source_to_confirmation_override(FactorSourceID::sample_ledger_other())
                .unwrap();
        ...
        fn config_4() {
            ...
            sut.add_factor_source_to_confirmation_override(FactorSourceID::sample_password())
                .unwrap();
            sut.add_factor_source_to_confirmation_override(FactorSourceID::sample_password_other())
                .unwrap();
            sut.add_factor_source_to_confirmation_override(FactorSourceID::sample_passphrase())
                .unwrap();
