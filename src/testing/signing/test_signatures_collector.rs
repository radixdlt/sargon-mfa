...
impl SignaturesCollector {
    ...
    pub(crate) fn test_prudent(transactions: impl IntoIterator<Item = TXToSign>) -> Self {
    ...
    pub(crate) fn test_lazy_always_skip(transactions: impl IntoIterator<Item = TXToSign>) -> Self {
